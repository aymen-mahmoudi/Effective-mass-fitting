...
"}")
        ...
        self.curve_kmin_lineEdit = QtWidgets.QLineEdit(self.verticalLayoutWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.curve_kmin_lineEdit.sizePolicy().hasHeightForWidth())
        self.curve_kmin_lineEdit.setSizePolicy(sizePolicy)
        self.curve_kmin_lineEdit.setObjectName("curve_kmin_lineEdit")
        self.horizontalLayout_3.addWidget(self.curve_kmin_lineEdit)
        self.curve_kmax_lineEdit = QtWidgets.QLineEdit(self.verticalLayoutWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.curve_kmax_lineEdit.sizePolicy().hasHeightForWidth())
        self.curve_kmax_lineEdit.setSizePolicy(sizePolicy)
        self.curve_kmax_lineEdit.setObjectName("curve_kmax_lineEdit")
        self.horizontalLayout_3.addWidget(self.curve_kmax_lineEdit)
        ...
        self.horizontalLayoutWidget_4.setGeometry(QtCore.QRect(829, 500, 471, 81))
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(840, 600, 461, 51))
        ...
        self.horizontalLayout_2.addWidget(self.T_label)
        self.T_lineEdit = QtWidgets.QLineEdit(self.layoutWidget)
        self.T_lineEdit.setMaxLength(6)
        self.T_lineEdit.setObjectName("T_lineEdit")
        self.horizontalLayout_2.addWidget(self.T_lineEdit)
        self.theta_slit_label = QtWidgets.QLabel(self.layoutWidget)
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(9)
        font.setBold(True)
        ...
        self.horizontalLayout_2.addWidget(self.theta_slit_label)
        self.n_lineEdit = QtWidgets.QLineEdit(self.layoutWidget)
        self.n_lineEdit.setObjectName("n_lineEdit")
        self.horizontalLayout_2.addWidget(self.n_lineEdit)
        self.horizontalLayoutWidget = QtWidgets.QWidget(Form)
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(840, 660, 461, 61))
        ...
        self.seebeck_output_label = QtWidgets.QLabel(self.horizontalLayoutWidget)
        ...
        self.horizontalLayout_10.addWidget(self.seebeck_output_label)
        self.T_label_3 = QtWidgets.QLabel(self.horizontalLayoutWidget)
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(14)
        font.setBold(True)
        ...
        self.horizontalLayout_10.addWidget(self.T_label_3)
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "Effective mass calculator (by aymen mahmoudi) V 1.0"))
        ...
        self.curve_center_lineEdit.setText(_translate("Form", "1"))
        ...
        self.E_label_2.setText(_translate("Form", "parabolic limits (min & max)"))
        self.curve_kmin_lineEdit.setText(_translate("Form", "-5"))
        self.curve_kmin_lineEdit.setPlaceholderText(_translate("Form", "Energy"))
        self.curve_kmax_lineEdit.setText(_translate("Form", "0"))
        self.curve_kmax_lineEdit.setPlaceholderText(_translate("Form", "Energy"))
        ...
        self.T_label.setText(_translate("Form", "<html><head/><body><p>Temerature (K)</p></body></html>"))
        self.T_lineEdit.setText(_translate("Form", "50"))
        self.T_lineEdit.setPlaceholderText(_translate("Form", "T en Kelvin"))
        self.theta_slit_label.setText(_translate("Form", "<html><head/><body><p>Density (X10-6 cm-3)</p></body></html>"))
        self.n_lineEdit.setText(_translate("Form", "1544"))
        self.n_lineEdit.setPlaceholderText(_translate("Form", "analyzer angle"))
        self.label_6.setText(_translate("Form", "Seebeck coefficent"))
        self.T_label_3.setText(_translate("Form", "<html><head/><body><p>uV/K</p></body></html>"))
